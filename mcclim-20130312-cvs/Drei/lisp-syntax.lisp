...
`form' should be highlighted."
  (if (and (typep view 'point-mark-view)
    ...
    (make-drawing-options :face (make-face :ink +wheat2+ :style (make-text-style nil nil nil)))
    (make-drawing-options :face (make-face :ink +wheat4+ :style (make-text-style nil nil nil)))))
...
(defparameter +list-marker+ 'backquote-list)
(defparameter +append-marker+ 'backquote-append)
(defparameter +list*-marker+ 'backquote-list*)
(defparameter +nconc-marker+ 'backquote-nconc)
(defparameter +vector-marker+ 'backquote-vector)
